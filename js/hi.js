...
$.widget("ui.dialog", {
	...
	_setData: function(key, value){
		...
		if($.widget.prototype._setData != undefined){
...
this.opts.containerId+a).hide()}};b.imgslide.defaults={total:0,containerId:"",playtime:2E3,autoplay:true,debug:false,display:"table-cell"}})(jQuery);var HiChat=new Object();HiChat.openWindow=function(url){var params="height=440,width=592,left=150px,top=80px,resizable=yes,scrollbars=no,status=no,toolbar=no,menubar=no,location=no";window.open(url,"",params);};HiChat.sendMsg=function(tqId){HiChat.openWindow("http://webchat.tq.cn/sendmain.jsp?uin="+tqId+"&ltype=100&agentid=1012160&tq_right_infocard_url=http://www."+HI_DOMAIN+"/tq/infocard");};HiChat.leaveMsg=function(tqId){HiChat.openWindow("http://qtt.tq.cn/leavemsg.do?agentid=1012160&uin="+tqId+"&ltype=100&page=http3A//www.thldl.org.cn/courses/html/1564.html&ispaymoney=1&localurl=http://qtt.tq.cn&tq_right_infocard_url=http://www."+HI_DOMAIN+"/tq/infocard");};HiChat.getSendMsgLink=function(tqId,large){var suffix=".gif";if(large){suffix="_large.gif";}
return"<img src='http://img."+HI_DOMAIN+"/images/ico/on_chat"+suffix+"' border='0' align='absmiddle' class='pngImg'/>&nbsp;&nbsp;<a rel='nofollow' href='javascript:HiChat.sendMsg("+tqId+")'>Chat Online</a>";};HiChat.getLeaveMsgLink=function(tqId,large){var suffix=".gif";if(large){suffix="_large.gif";}
return"<img src='http://img."+HI_DOMAIN+"/images/ico/off_chat"+suffix+"' border='0' align='absmiddle' class='pngImg'/>&nbsp;&nbsp;<a rel='nofollow' href='javascript:HiChat.leaveMsg("+tqId+")'>Offline</a>";};HiChat.getEmptyLink=function(large){var suffix=".gif";if(large){suffix="_large.gif";}
return"<img src='http://img."+HI_DOMAIN+"/images/ico/off_chat"+suffix+"' border='0' align='absmiddle' class='pngImg'/>&nbsp;&nbsp;<a rel='nofollow' href='javascript:void(0);'>Offline</a>";};HiChat.listLinks=function(tqIds,prefix){if(prefix==null){prefix="tqChat";}
var url="http://float2006.tq.cn/getonlineflag.js?uin="+tqIds;$.getScript(url,function(){if(typeof(OnLineFlagArray)!="undefined"){var tqIdArray=tqIds.split("|");if(tqIdArray){for(var index=0;index<tqIdArray.length;index++){var tqId=tqIdArray[index];var onlineFlag=OnLineFlagArray[index];if(tqId==0){break;}else if(tqId<10000){$("#"+prefix+index).html(HiChat.getEmptyLink());}else{if(onlineFlag>=20){$("#"+prefix+index).html(HiChat.getSendMsgLink(tqId));}else{$("#"+prefix+index).html(HiChat.getLeaveMsgLink(tqId));}}}}}});};HiChat.listLinksNew=function(tqIds,prefix){if(tqIds==null||tqIds.length==0){return;}
if(prefix==null){prefix="tqChat";}
var url="http://float2006.tq.cn/getonlineflag.js?uin="+tqIds;$.getScript(url,function(){if(typeof(OnLineFlagArray)!="undefined"){var tqIdArray=tqIds.split("|");if(tqIdArray){for(var index=0;index<tqIdArray.length;index++){var tqId=tqIdArray[index];var onlineFlag=OnLineFlagArray[index];var obj=$("[name='"+prefix+tqId+"']");if(tqId==0){break;}else if(tqId<10000){obj.html(HiChat.getEmptyLink());}else{if(onlineFlag>=20){obj.html(HiChat.getSendMsgLink(tqId));}else{obj.html(HiChat.getLeaveMsgLink(tqId));}}}}}});};HiChat.singleLink=function(tqId,styleClass,styleClassLarge){var url="http://float2006.tq.cn/getonlineflag.js?uin="+tqId;$.getScript(url,function(){if(typeof(OnLineFlagArray)!="undefined"){var link="";var linkLarge="";if(tqId<10000){link=HiChat.getEmptyLink();linkLarge=HiChat.getEmptyLink(true);}else{if(OnLineFlagArray[0]>=20){link=HiChat.getSendMsgLink(tqId);linkLarge=HiChat.getSendMsgLink(tqId,true);}else{link=HiChat.getLeaveMsgLink(tqId);linkLarge=HiChat.getLeaveMsgLink(tqId,true);}}
$("."+styleClass).each(function(){$(this).html(link);});$("."+styleClassLarge).each(function(){$(this).html(linkLarge);});}});};/*
